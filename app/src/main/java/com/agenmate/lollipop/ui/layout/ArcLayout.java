...
public class ArcLayout extends ViewGroup {
    ...
    private static Animation createExpandAnimation(float fromXDelta, float toXDelta, float fromYDelta, float toYDelta,
        ...
        Animation rotateAnimation = new RotateAndTranslateAnimation(0, toXDelta, 0, toYDelta, 0, 720);
        ...
        alphaAnimation.setStartOffset(startOffset + preDuration);
        alphaAnimation.setDuration(duration - preDuration);
    ...
    private void onAllAnimationsEnd() {
        ...
        requestLayout();
        if(arcAnimationEndListener != null)
            arcAnimationEndListener.onAnimationEnd(mExpanded);
    }

    public interface OnArcAnimationEndListener {
        void onAnimationEnd(boolean isExpanded);
    }

    private OnArcAnimationEndListener arcAnimationEndListener;

    public void setOnArcAnimationEndListener(OnArcAnimationEndListener arcAnimationEndListener){
        this.arcAnimationEndListener = arcAnimationEndListener;
    }
