...
public class ArcMenu extends RelativeLayout {
    ...
    public void setControlLayoutClickListener(OnClickListener listener){
    ...
    public void setOnArcAnimationEndListener(ArcLayout.OnArcAnimationEndListener listener){
        mArcLayout.setOnArcAnimationEndListener(listener);
    }
}
