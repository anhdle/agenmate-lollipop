...
public class SeekArc extends View {
	...
	private void init(Context context, AttributeSet attrs, int defStyle) {
		...
		shadowPaint.setColor(arcColor);
		shadowPaint.setAntiAlias(true);
		shadowPaint.setStyle(Paint.Style.FILL);
		int shadowWidth = ScreenUtils.dpToPx(context, 2);
		shadowPaint.setShadowLayer(shadowWidth, 0, shadowWidth, Color.argb(100, 0, 0, 0));
	...
	protected void onDraw(Canvas canvas) {		
		...
		canvas.drawArc(mArcRect, arcStart, arcSweep, false, shadowPaint);
	...
	public void setTouchInSide(boolean isEnabled) {
		...
		mTouchIgnoreRadius = (float) mArcRadius / 8 * 7;
